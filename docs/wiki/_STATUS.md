...
Numeración de specs: global y única (SPEC-001, SPEC-002…), sin huecos. Próximo número libre: **SPEC-001**.

| # | Fase | Archivo | Estado | Fecha | Specs |
|---|------|---------|--------|-------|-------|
| 1 | Mapa del sistema | `00-mapa.md` | COMPLETA | 2026-07-03 | 0 (fase base, sin specs) |
| 2 | Calidad skills & triggering | `01-calidad-skills-triggering.md` | PENDIENTE | — | — |
