---
name: prototype
description: "Build several genuinely different versions — variants, takes, options, directions — of one UI piece behind a visual picker, so you flip through them live and promote the winner. Use to explore a look before committing, or when you do not yet know what you want something to look like."
tags: [design, variants, exploration, picker, ui]
recommends: [design, animate, nextjs]
profiles: [full]
...
**Hand-offs.** Once a variant wins, its motion should survive `../review-animations/SKILL.md`. The
visual system the variants inherit is `../design/SKILL.md`'s. Dependencies belong to
`../pick-ui-library/SKILL.md` — do not install a library to explore a layout.
...
4. **The picker is chrome, not a contestant.** Its exact markup, styles, and behavior are specified in [references/picker.md](references/picker.md) — copy them verbatim. Its look is not a design decision and never adapts to the project.
