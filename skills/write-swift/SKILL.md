---
name: write-swift
description: "Modern Swift at the language level: structs and value types versus classes, Swift 6 data-race safety, actors, async/await and task groups, `some` versus `any`, ARC and retain cycles, Swift Testing, macros. Use for a deadlock, a hang, a data race, a concurrency error, or migrating to Swift 6."
tags: [swift, language, concurrency, generics, testing]
recommends: [swift-ios, apple-design, testing-web]
profiles: [full]
...
**Hand-offs.** This skill owns the **language**: value types, concurrency, generics, performance,
testing. The **platform** — SwiftUI views, UIKit, app lifecycle, Xcode projects, App Store shipping,
iOS APIs — is `../swift-ios/SKILL.md`'s. Interface feel, springs and materials are
`../apple-design/SKILL.md`'s. If the question is "how do I lay out this view", you are in the wrong
file; if it is "why does this actor deadlock", you are in the right one.
